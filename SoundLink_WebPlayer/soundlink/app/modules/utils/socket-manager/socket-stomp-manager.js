angular.module('soundlink').service("socketStompService", socketStompService);

socketStompService.$inject = ['SOCKET_EVENTS', 'config', '$q', '$cookies', 'tokenStorage'];

function socketStompService(SOCKET_EVENTS, config, $q, $cookies, tokenStorage) {
