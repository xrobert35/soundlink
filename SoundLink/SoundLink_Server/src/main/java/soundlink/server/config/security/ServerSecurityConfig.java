...
import soundlink.server.config.security.filter.StatelessAuthenticationFilter;
import soundlink.server.config.security.filter.StatelessLoginFilter;
import soundlink.server.config.security.service.TokenAuthenticationService;
...
public class ServerSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// new NegatedRequestMatcher(new
		// AntPathRequestMatcher("/soundlinkMessage/**")),
		// new NegatedRequestMatcher(new AntPathRequestMatcher("/logout*/**",
		// HttpMethod.OPTIONS.toString()))));
