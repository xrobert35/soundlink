 ...
 */
@Rest(rootUrl = SoundlinkConfig.SERVEUR_URL + "soundlink", converters = { MappingJackson2HttpMessageConverter.class }, interceptors = {RequestInterceptor.class},
        requestFactory = RequestFactory.class)
public interface SoundlinkRestService extends RestClientErrorHandling {

    @Post("/login")
    ClientHttpResponse login(@Body Connexion connexion);
